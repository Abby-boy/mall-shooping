...
import com.dingjiajia.mall.product.service.AttrAttrgroupRelationService;
...
public class AttrGroupController {
    ...
    /**
     * 保存新建关联关系
     * @path  /product/attrgroup/attr/relation
     */
    ...
    /**
     * 获取当前分类下的所有属性分组而且带上所有的属性值
     * @path /product/attrgroup/{catelogId}/withattr
     */
    ...
    /**
     * 查询没有被关联的属性
     * @path  /product/attrgroup/{attrgroupId}/noattr/relation
     * @param attrgroupId
     * @param params
     * @return
     */
